...
1. Visit [Paradex](https://app.paradex.trade)
2. Connect your wallet
3. Navigate to **Settings → Key Management**
4. Click **Subkeys** tab
5. Click **+ Add New Key**
6. Enter a name (e.g., "Volume Bot")
7. **Copy the L2 Private Key** (shown only once!)
...
2. **Use testnet** - Practice on testnet.paradex.trade
3. **Monitor closely** - Watch the first hour carefully
4. **Set stop-loss** - Use `MAX_LOSS` parameter
5. **Use subkeys** - Protect your main account
...
- **Issues:** [GitHub Issues](https://github.com/yourusername/paradex-volume-bot/issues)
- **Paradex Docs:** [docs.paradex.trade](https://docs.paradex.trade)
- **Paradex Discord:** [discord.gg/paradex](https://discord.gg/paradex)
